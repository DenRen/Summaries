...
Типы функций могут превращаться к указатели на функции, и всё, что говорилось про вывод типа для массивов, применимо к выводу типа для функций и их преобразованием в указатели на функцию.
...
За один любопытным исключением, вывод типа *auto* представляет собой вывод типа *шаблона*.
...
const auto& crx = x;  // crx - неуниферсальная ссылка
...
Если тот же инициализатор передаётся шаблона, то вывод типа оказывается неудачным.
```cpp
